...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'jspm_packages/github/angular/bower-angular-animate@1.5.0/angular-animate.js',
      'jspm_packages/github/angular/bower-angular-sanitize@1.5.0/angular-sanitize.js',
      'jspm_packages/github/angular/bower-angular-cookies@1.5.0/angular-cookies.js',
